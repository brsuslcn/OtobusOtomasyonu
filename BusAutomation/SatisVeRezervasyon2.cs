...
{
    public partial class SatisVeRezervasyon2 : Form
    {
        ...
        public SatisVeRezervasyon2()
        {
            InitializeComponent();
        }

        private void SatisVeRezervasyon2_Load(object sender, EventArgs e)
        {
